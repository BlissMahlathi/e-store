...
export function CartWishlistSpotlight() {
  ...
  return (
    <Card className="overflow-hidden border-border/40 bg-linear-to-br from-background via-background to-muted/30 shadow-xl">
      ...
      <CardContent className="space-y-6 pt-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          {/* Cart Card */}
          <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-linear-to-br from-card to-card/80 p-6 shadow-sm transition-all duration-300 hover:border-primary/30 hover:shadow-lg">
            ...
            <div className="relative">
              <div className="flex items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-primary/20 to-primary/5 shadow-inner">
          ...
          {/* Wishlist Card */}
          <div className="group relative overflow-hidden rounded-2xl border border-border/50 bg-linear-to-br from-card to-card/80 p-6 shadow-sm transition-all duration-300 hover:border-rose-500/30 hover:shadow-lg">
            ...
            <div className="relative">
              <div className="flex items-center justify-between">
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-linear-to-br from-rose-500/20 to-rose-500/5 shadow-inner">
        ...
        {/* Checkout Section */}
        <div className="rounded-2xl border border-border/50 bg-linear-to-br from-muted/60 via-muted/40 to-transparent p-6">
